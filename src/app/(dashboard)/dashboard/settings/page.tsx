...
import { Save, Bell, Calendar, ArrowRightLeft, AlertTriangle } from 'lucide-react'
...
export default function SettingsPage() {
  ...
  useEffect(() => {
    if (user?.notification_preferences && typeof user.notification_preferences === 'object' && !Array.isArray(user.notification_preferences)) {
      setPreferences(prev => ({
        ...prev,
        ...
        <CardContent className="space-y-4">
          ...
          <div className="grid gap-2 text-sm">
            <div className="flex justify-between">
              ...
              <span className="font-medium">{user.desired_weekly_hours || 40}h</span>
            </div>
            <div className="flex justify-between">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={v => setPreferences(p => ({ ...p, schedule_published: v }))}
              />
            </div>
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
              ...
              <Switch
                ...
                onCheckedChange={v => setPreferences(p => ({ ...p, shift_assigned: v }))}
              />
            </div>
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
              ...
              <Switch
                ...
                onCheckedChange={v => setPreferences(p => ({ ...p, shift_unassigned: v }))}
              />
            </div>
            <Separator />
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={v => setPreferences(p => ({ ...p, swap_requested: v }))}
              />
            </div>
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
              ...
              <Switch
                ...
                onCheckedChange={v => setPreferences(p => ({ ...p, swap_approved: v }))}
              />
            </div>
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
              ...
              <Switch
                ...
                onCheckedChange={v => setPreferences(p => ({ ...p, swap_rejected: v }))}
              />
            </div>
            <Separator />
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={v => setPreferences(p => ({ ...p, overtime_warning: v }))}
              />
            </div>
          </div>
        </CardContent>
