...
import { Bell, Check, CheckCheck, Calendar, ArrowRightLeft, AlertTriangle, Info, Mail } from 'lucide-react'
          ...
          {notifications.map(notif => {
            ...
            return (
              <div
                ...
                `}
              >
                <div className={`mt-0.5 p-1.5 rounded-full ${!notif.is_read ? 'bg-blue-100 text-blue-600' : 'bg-muted text-muted-foreground'}`}>
                ...
                {!notif.is_read && (
                  <Button size="sm" variant="ghost" className="shrink-0" onClick={() => handleMarkRead(notif.id)}>
