...
export type StaffLocation = Database['public']['Tables']['staff_locations']['Row']
export type ManagerLocation = Database['public']['Tables']['manager_locations']['Row']
...
export type OvertimeOverride = Database['public']['Tables']['overtime_overrides']['Row']
