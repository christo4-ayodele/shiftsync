...
// Demo users
const USERS = [
  { email: 'admin@coastaleats.com', password: 'password123', name: 'Alex Rivera', role: 'admin' },
  { email: 'mgr.downtown@coastaleats.com', password: 'password123', name: 'Jordan Chen', role: 'manager' },
  { email: 'mgr.harbor@coastaleats.com', password: 'password123', name: 'Priya Sharma', role: 'manager' },
  { email: 'staff1@coastaleats.com', password: 'password123', name: 'Marcus Williams', role: 'staff' },
  { email: 'staff2@coastaleats.com', password: 'password123', name: 'Sofia Martinez', role: 'staff' },
  { email: 'staff3@coastaleats.com', password: 'password123', name: 'Tyler Johnson', role: 'staff' },
  { email: 'staff4@coastaleats.com', password: 'password123', name: 'Emma Davis', role: 'staff' },
  { email: 'staff5@coastaleats.com', password: 'password123', name: 'Liam Brown', role: 'staff' },
  { email: 'staff6@coastaleats.com', password: 'password123', name: 'Olivia Wilson', role: 'staff' },
  { email: 'staff7@coastaleats.com', password: 'password123', name: 'Noah Taylor', role: 'staff' },
  { email: 'staff8@coastaleats.com', password: 'password123', name: 'Ava Anderson', role: 'staff' },
  { email: 'staff9@coastaleats.com', password: 'password123', name: 'James Garcia', role: 'staff' },
  { email: 'staff10@coastaleats.com', password: 'password123', name: 'Isabella Lopez', role: 'staff' },
]
...
async function seed() {
  ...
  await supabase.from('locations').upsert([
    { id: LOCATION_IDS.downtown, name: 'Downtown Bistro', address: '123 Main St, Charleston, SC 29401', timezone: 'America/New_York' },
    { id: LOCATION_IDS.harbor, name: 'Harbor View', address: '456 Harbor Dr, Charleston, SC 29401', timezone: 'America/New_York' },
    { id: LOCATION_IDS.folly, name: 'Folly Beach Grill', address: '789 Center St, Folly Beach, SC 29439', timezone: 'America/New_York' },
    { id: LOCATION_IDS.airport, name: 'Airport Express', address: '5500 International Blvd, N Charleston, SC 29418', timezone: 'America/New_York' },
  ])
  ...
  const staffIds = USERS.filter(u => u.role === 'staff').map(u => userIds[u.email]).filter(Boolean)
  ...
  await supabase.from('staff_skills').upsert(skillAssignments, { onConflict: 'staff_id,skill_id' })
  ...
  const shiftSkills = [
    ...
    SKILL_IDS.saute, SKILL_IDS.expo,
  ]
        ...
        for (let s = 0; s < numShifts; s++) {
          ...
          const { data: shift, error } = await supabase
            ...
            .insert({
              ...
              notes: dayOffset === 5 || dayOffset === 6 ? 'Weekend rush expected' : null,
            })
            .select()
            .single()
  ...
  const staffByLocation: Record<string, string[]> = {
    [LOCATION_IDS.downtown]: [staffIds[0], staffIds[1], staffIds[2], staffIds[6], staffIds[7], staffIds[8], staffIds[9]],
    [LOCATION_IDS.harbor]: [staffIds[3], staffIds[4], staffIds[5], staffIds[6], staffIds[7], staffIds[8], staffIds[9]],
    [LOCATION_IDS.folly]: [staffIds[0], staffIds[1], staffIds[2], staffIds[8], staffIds[9]],
    [LOCATION_IDS.airport]: [staffIds[3], staffIds[4], staffIds[5], staffIds[8], staffIds[9]],
  }
  ...
  const notifData = [
    { user_id: staffIds[0], type: 'schedule_published', title: 'Schedule Published', message: 'This week\'s schedule for Downtown Bistro has been published.', is_read: false },
    { user_id: staffIds[0], type: 'shift_assigned', title: 'New Shift', message: 'You\'ve been assigned to Grill shift on Monday 7:00 AM - 3:00 PM.', is_read: true },
    { user_id: staffIds[1], type: 'schedule_published', title: 'Schedule Published', message: 'This week\'s schedule for Downtown Bistro has been published.', is_read: false },
    { user_id: staffIds[2], type: 'swap_requested', title: 'Swap Request', message: 'Marcus Williams wants to swap shifts with you.', is_read: false },
    { user_id: mgrDowntownId, type: 'overtime_warning', title: 'Overtime Warning', message: 'Marcus Williams is approaching 35 hours this week.', is_read: false },
  ]
  ...
  const auditEntries = [
    {
      ...
      entity_id: Object.values(scheduleIds)[0] || '00000000-0000-0000-0000-000000000000',
      action: 'schedule_published',
      changed_by: adminId,
      metadata: { location: 'Downtown Bistro', week: format(thisMonday, 'yyyy-MM-dd') },
    },
    {
      entity_type: 'shift',
    ...
    },
    {
      ...
      metadata: { from: 'Marcus Williams', to: 'Tyler Johnson', reason: 'Family event' },
    },
  ]
  ...
  console.log('\n📍 Locations:')
  console.log('  Downtown Bistro, Harbor View, Folly Beach Grill, Airport Express')
  console.log(`\n📊 Data created:`)
